/*
 * Generated from Xiph RNNoise model data at the revision recorded in REVISION.
 * Copyright (c) 2007-2017, 2024 Jean-Marc Valin and RNNoise contributors.
 * SPDX-License-Identifier: BSD-3-Clause
 *
 * The upstream generated rnnoise_data.c also embeds tens of megabytes of C
 * arrays. VolEq loads the equivalent binary model instead, so only the model
 * topology initializer is retained here.
 */

...
VolEq Community processes captured audio locally in memory. The current application does not intentionally record audio to disk, transmit audio, create user accounts, include analytics, or contact a VolEq server.
